...
See [Theme Audit](./theme-audit.md) for a full audit of the theme system, known issues (undefined variables, hardcoded colors, light-mode contrast), and fix recommendations.
